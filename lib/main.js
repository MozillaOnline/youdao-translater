...
function allowTranslationInfoBar(aURI) {
  ...
  if (prefs.get('extensions.mozcn-translation.disabled', false)) {
    return false;
  }
...
function messageListener(msg) {
  ...
  if (msg.data.detectedLanguage == 'en' && allowTranslationInfoBar(uri)) {
...
exports.main = function() {
  ...
  require('sdk/system/unload').when(function() {
    ...
    [].forEach.call(windows.browserWindows, function(win) {
      let gBrowser = viewFor(win).gBrowser;
      [].forEach.call(gBrowser.tabs, function(tab) {
